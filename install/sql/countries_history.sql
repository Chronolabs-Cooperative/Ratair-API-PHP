...
--
-- Table structure for table `countries_history`
--
...
CREATE TABLE `countries_history` (
  `historyid` mediumint(255) NOT NULL AUTO_INCREMENT,
  ...
  KEY `SEARCHING` (`typal`,`countryid`,`typal_start`,`typal_end`,`typal_seconds`,`created`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `countries_history`
--

LOCK TABLES `countries_history` WRITE;
/*!40000 ALTER TABLE `countries_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `countries_history` ENABLE KEYS */;
UNLOCK TABLES;
