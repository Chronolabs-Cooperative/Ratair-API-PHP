...
if (!defined('API_MAINFILE_INCLUDED')) {
    ...
    define('API_ROOT_PATH', '/home/mynamesnot/eclipse-workspace/licenses.localhost');

    // For forward compatibility
    // Physical path to the API library directory WITHOUT trailing slash
    define('API_PATH', '/home/mynamesnot/eclipse-workspace/licenses.localhost/data');
    ...
    // Example: define('API_URL', 'http://licenses.localhost');
    define('API_URL', 'http://licenses.localhost');
    ...
    define('API_COOKIE_DOMAIN', 'licenses.localhost');
